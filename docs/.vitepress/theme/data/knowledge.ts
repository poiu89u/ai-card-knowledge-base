...
export const cards: KnowledgeCard[] = [
  ...
  },
  {
    ...
    title: 'AGI（通用人工智能）',
    category: 'AI 基础认知',
    summary: '所谓通用，指的是模型能像人类一样，在没有专门训练的情况下，跨任意场景、自主理解并完成各种复杂的智力任务。',
    plain: '所谓通用，指的是模型能像人类一样，在没有专门训练的情况下，跨任意场景、自主理解并完成各种复杂的智力任务。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['AGI（通用人工智能）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: 'LLM（大语言模型）',
    category: 'AI 基础认知',
    summary: '基于Transformer架构，用海量文本数据训练出来的自回归语言模。',
    plain: '基于Transformer架构，用海量文本数据训练出来的自回归语言模。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['LLM（大语言模型）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    category: '主流大模型体系',
    summary: '完成大规模通用预训练后的模型，可作为各类AI应用的底座。',
    plain: '完成大规模通用预训练后的模型，可作为各类AI应用的底座。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['模型选型', '能力理解', '技术沟通'],
    tags: ['Foundation Model（基础模型）', '主流大模型体系'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: '开源模型 vs 闭源模型',
    category: '主流大模型体系',
    summary: '开源模型如Llama、Qwen、ChatGLM，支持私有部署与自主调优；闭源模型如GPT-4o、Claude、文心一言，则以API服务…',
    plain: '开源模型如Llama、Qwen、ChatGLM，支持私有部署与自主调优；闭源模型如GPT-4o、Claude、文心一言，则以API服务为主。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['模型选型', '能力理解', '技术沟通'],
    tags: ['开源模型 vs 闭源模型', '主流大模型体系'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'SLM（小语言模型）',
    category: '主流大模型体系',
    summary: '指参数规模在几十亿以下，专门为资源受限环境优化的语言模型。',
    plain: '指参数规模在几十亿以下，专门为资源受限环境优化的语言模型。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['模型选型', '能力理解', '技术沟通'],
    tags: ['SLM（小语言模型）', '主流大模型体系'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'MoE（混合专家模型）',
    category: '主流大模型体系',
    summary: '大模型提升性能同时控制成本的核心技术路线。',
    plain: '大模型提升性能同时控制成本的核心技术路线。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['模型选型', '能力理解', '技术沟通'],
    tags: ['MoE（混合专家模型）', '主流大模型体系'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    category: 'AI 基础认知',
    summary: '大模型能力形成的最核心阶段。',
    plain: '大模型能力形成的最核心阶段。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['Pre-Training（预训练）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    category: 'AI 基础认知',
    summary: '在预训练完成之后，对模型进行的一系列「塑形」工作。',
    plain: '在预训练完成之后，对模型进行的一系列「塑形」工作。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['Post-Training（后训练）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'SFT（监督微调）',
    category: '进阶常识',
    summary: '后训练的第一步，也是最基础的一步。',
    plain: '后训练的第一步，也是最基础的一步。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['SFT（监督微调）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '大模型对齐人类偏好的经典方法。',
    plain: '大模型对齐人类偏好的经典方法。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['RLHF（基于人类反馈的强化学习）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'PPO（近端策略优化）',
    category: '进阶常识',
    summary: 'RLHF流程中最核心的强化学习算法，每次只允许模型做小幅度的调整和改进。',
    plain: 'RLHF流程中最核心的强化学习算法，每次只允许模型做小幅度的调整和改进。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['PPO（近端策略优化）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'DPO（直接偏好优化）',
    category: '进阶常识',
    summary: '目前最主流的RLHF替代方案。',
    plain: '目前最主流的RLHF替代方案。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['DPO（直接偏好优化）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'GRPO（分组相对偏好优化）',
    category: '进阶常识',
    summary: '2025年以来最受关注的下一代对齐技术，是OpenAI、Anthropic、DeepSeek等头部公司重点使用的方法。',
    plain: '2025年以来最受关注的下一代对齐技术，是OpenAI、Anthropic、DeepSeek等头部公司重点使用的方法。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['GRPO（分组相对偏好优化）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'NLP（自然语言处理）',
    category: 'AI 基础认知',
    summary: '人工智能领域最古老也最重要的分支之一，研究如何让计算机理。',
    plain: '人工智能领域最古老也最重要的分支之一，研究如何让计算机理。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['NLP（自然语言处理）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '分类 vs 回归',
    category: 'AI 基础认知',
    summary: '该概念来自 PDF 知识点，已改写为卡片。',
    plain: '该概念来自 PDF 知识点，已改写为卡片。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['分类 vs 回归', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    category: 'AI 基础认知',
    summary: '展示分类模型预测结果的表格，是理解精确率、召回率、。',
    plain: '展示分类模型预测结果的表格，是理解精确率、召回率、。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['混淆矩阵（Confusion Matrix）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    title: '训练集/验证集/测试集',
    category: 'AI 基础认知',
    summary: '机器学习的标准数据划分方式：。',
    plain: '机器学习的标准数据划分方式：。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['训练集/验证集/测试集', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    category: 'AI 基础认知',
    summary: '传统机器学习中最重要的环节之一，从原始数据中提取出对模型有用的特征的过程。',
    plain: '传统机器学习中最重要的环节之一，从原始数据中提取出对模型有用的特征的过程。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['特征工程（Feature Engineering）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    title: 'MLLM（多模态大模型）',
    category: '主流大模型体系',
    summary: '能够同时理解和生成文本、图像、音频、视频等多种信息形式的大模型。',
    plain: '能够同时理解和生成文本、图像、音频、视频等多种信息形式的大模型。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['模型选型', '能力理解', '技术沟通'],
    tags: ['MLLM（多模态大模型）', '主流大模型体系'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    category: 'AIGC 应用细分',
    summary: '当前文生图、文生视频领域最主流的生成架构。',
    plain: '当前文生图、文生视频领域最主流的生成架构。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['扩散模型（Diffusion Model）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: 'OCR（光学字符识别）',
    category: 'AIGC 应用细分',
    summary: '将图片、扫描件中的印刷体或手写体文字，转化为计算机可编辑的文本格式的技术。',
    plain: '将图片、扫描件中的印刷体或手写体文字，转化为计算机可编辑的文本格式的技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['OCR（光学字符识别）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    category: 'AIGC 应用细分',
    summary: '计算机视觉的基础能力之一。',
    plain: '计算机视觉的基础能力之一。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['目标检测（Object Detection）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    title: 'ASR（自动语音识别）',
    category: 'AIGC 应用细分',
    summary: '将人类的语音信号转化为文字的技术。',
    plain: '将人类的语音信号转化为文字的技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['ASR（自动语音识别）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: 'TTS（文本转语音）',
    category: 'AIGC 应用细分',
    summary: '将文字内容转化为自然流畅的人类语音的技术。',
    plain: '将文字内容转化为自然流畅的人类语音的技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['TTS（文本转语音）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: '监督学习',
    category: 'AI 基础认知',
    summary: '最经典、最常用的机器学习方法，利用带标签的数据来训练模型。',
    plain: '最经典、最常用的机器学习方法，利用带标签的数据来训练模型。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
  ...
  },
  {
    ...
    title: '无监督学习',
    category: 'AI 基础认知',
    summary: '不需要任何人工标注数据的机器学习方法。',
    plain: '不需要任何人工标注数据的机器学习方法。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
  ...
  },
  {
    ...
    title: '强化学习',
    category: 'AI 基础认知',
    summary: '一种通过「试错」来学习的机器学习方法。',
    plain: '一种通过「试错」来学习的机器学习方法。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '在已经训练好的预训练模型基础上，使用特定领域的少量数据继续训练，让模型适应特定场景和任务的技术。',
    plain: '在已经训练好的预训练模型基础上，使用特定领域的少量数据继续训练，让模型适应特定场景和任务的技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['Fine-tuning（微调）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    category: 'AI 基础认知',
    summary: '模型在训练数据上表现得非常完美，但一遇到从未见过的新数据就表现很差的现象。',
    plain: '模型在训练数据上表现得非常完美，但一遇到从未见过的新数据就表现很差的现象。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['过拟合（Overfitting）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    category: 'AI 基础认知',
    summary: '与过拟合完全相反的现象，模型在训练数据上本身就表现很差，无法学习到数据的基本规律，自然也无法在新数据上取得好的效果。',
    plain: '与过拟合完全相反的现象，模型在训练数据上本身就表现很差，无法学习到数据的基本规律，自然也无法在新数据上取得好的效果。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['欠拟合（Underfitting）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    category: 'AI 基础认知',
    summary: '模型面对从未见过的新数据和新场景时的适应能力，是衡量模型真实价值的最重要指标之一。',
    plain: '模型面对从未见过的新数据和新场景时的适应能力，是衡量模型真实价值的最重要指标之一。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['入门学习', '面试解释', '概念区分'],
    tags: ['泛化能力（Generalization）', 'AI 基础认知'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '一种大幅提升大模型复杂推理能力的技术。',
    plain: '一种大幅提升大模型复杂推理能力的技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['CoT（Chain of Thought，思维链）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '大模型涌现出来的一种特殊能力。',
    plain: '大模型涌现出来的一种特殊能力。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['Few-shot Learning（少样本学习）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  {
    id: 'zero-shot',
    title: 'Zero-shot Learning（零样本学习）',
    category: '进阶常识',
    summary: '大模型最强大的能力之一。',
    plain: '大模型最强大的能力之一。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    ...
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['Zero-shot Learning（零样本学习）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: '记忆机制（Memory）',
    category: '进阶常识',
    summary: 'Agent的核心能力之一，决定AI是否具备持续交互能力。',
    plain: 'Agent的核心能力之一，决定AI是否具备持续交互能力。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['记忆机制（Memory）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: '规划能力（Planning）',
    category: '进阶常识',
    summary: 'Agent区别于传统对话系统的最关键能力，能够将一个模糊复杂的大目标，自动拆解成多个清晰可执行的小任务，然后按照合理的顺序一步步执行。',
    plain: 'Agent区别于传统对话系统的最关键能力，能够将一个模糊复杂的大目标，自动拆解成多个清晰可执行的小任务，然后按照合理的顺序一步步执行。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['规划能力（Planning）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['上下文学习（In-Context Learning）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '在模型对齐过程中不可避免的能力损失。',
    plain: '在模型对齐过程中不可避免的能力损失。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['对齐税（Alignment Tax）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '将一个复杂任务拆解成多个简单的子任务，每个子任务对应一个专门的Prompt，前一个Prompt的输出作为后一个Prompt的输入。',
    plain: '将一个复杂任务拆解成多个简单的子任务，每个子任务对应一个专门的Prompt，前一个Prompt的输出作为后一个Prompt的输入。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['提示链（Prompt Chaining）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '由大模型自动生成的高质量标注数据，是解决垂类AI冷启动数据不足问题的最有效方法之一。',
    plain: '由大模型自动生成的高质量标注数据，是解决垂类AI冷启动数据不足问题的最有效方法之一。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['合成数据（Synthetic Data）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '长上下文和RAG系统的核心优化技术。',
    plain: '长上下文和RAG系统的核心优化技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['上下文压缩（Context Compression）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  {
    id: 'reflection',
    title: '反思机制（Reflection）',
    category: '进阶常识',
    summary: '让模型在输出结果之后，先进行自我检查和修正，然后再把最终结果返回给用户的技术。',
    plain: '让模型在输出结果之后，先进行自我检查和修正，然后再把最终结果返回给用户的技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['反思机制（Reflection）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '大模型与生俱来的核心缺陷，会生成一些看起来非常合理、但实。',
    plain: '大模型与生俱来的核心缺陷，会生成一些看起来非常合理、但实。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['Hallucination（幻觉）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  {
    id: 'temperature',
    title: 'Temperature（温度系数）',
    category: '进阶常识',
    summary: '控制模型输出随机性和创造性的核心参数，取值范围通常在0~2之间。',
    plain: '控制模型输出随机性和创造性的核心参数，取值范围通常在0~2之间。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['Temperature（温度系数）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: 'Top P/Top K',
    category: '进阶常识',
    summary: '另外两个控制模型采样范围的重要参数，通常和Temperature配合使用来精细调节输出效果。',
    plain: '另外两个控制模型采样范围的重要参数，通常和Temperature配合使用来精细调节输出效果。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['Top P/Top K', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: '多轮对话',
    category: '进阶常识',
    summary: '让模型能够记住之前的对话内容，持续理解上下文并维持话题一致性的能力。',
    plain: '让模型能够记住之前的对话内容，持续理解上下文并维持话题一致性的能力。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '识别用户输入背后真正想完成的任务。',
    plain: '识别用户输入背后真正想完成的任务。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['意图识别（Intent Recognition）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  {
    id: 'slot-filling',
    title: '槽位填充（Slot Filling）',
    category: '进阶常识',
    summary: '在明确用户意图之后，收集完成该任务所必需的关键参数。',
    plain: '在明确用户意图之后，收集完成该任务所必需的关键参数。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['槽位填充（Slot Filling）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    category: '数据 & 存储',
    summary: '一种用「实体-关系」结构化方式来组织知识的技术。',
    plain: '一种用「实体-关系」结构化方式来组织知识的技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['知识组织', '数据检索', '企业知识库'],
    tags: ['知识图谱（Knowledge Graph）', '数据 & 存储'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  {
    id: 'digital-human',
    title: '数字人（Digital Human）',
    category: 'AIGC 应用细分',
    summary: '结合AI驱动和虚拟形象生成技术的人机交互系统。',
    plain: '结合AI驱动和虚拟形象生成技术的人机交互系统。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['数字人（Digital Human）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: 'GAN（生成对抗网络）',
    category: 'AIGC 应用细分',
    summary: '曾经主导图像生成领域的经典生成模型架构，核心思想是「对抗。',
    plain: '曾经主导图像生成领域的经典生成模型架构，核心思想是「对抗。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['GAN（生成对抗网络）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    title: 'VAE（变分自编码器）',
    category: 'AIGC 应用细分',
    summary: '另一种经典的生成模型架构，核心思想是把高维的图像数据压缩到一个低维的「潜在空间」中，然后再从这个潜在空间重建出原始图像。',
    plain: '另一种经典的生成模型架构，核心思想是把高维的图像数据压缩到一个低维的「潜在空间」中，然后再从这个潜在空间重建出原始图像。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['VAE（变分自编码器）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    category: 'AIGC 应用细分',
    summary: '将Transformer架构应用于图像处理的革命性技术。',
    plain: '将Transformer架构应用于图像处理的革命性技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['ViT（Vision Transformer）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    category: 'AIGC 应用细分',
    summary: '将Transformer架构引入扩散模型的新一代生成架构。',
    plain: '将Transformer架构引入扩散模型的新一代生成架构。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AIGC 应用', '内容生成', '效果复核'],
    tags: ['DiT（Diffusion Transformer）', 'AIGC 应用细分'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'AI 产品生命周期',
    category: 'AI 行业 & 场景应用',
    summary: '一个完整的AI产品从想法到落地再到持续运营的全过程，一般会经历。',
    plain: '一个完整的AI产品从想法到落地再到持续运营的全过程，一般会经历。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['AI 产品生命周期', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  },
  {
    ...
    title: '模型选型',
    category: 'AI 行业 & 场景应用',
    summary: '决定AI产品底层能力上限和最终成本结构的最关键一步。',
    plain: '决定AI产品底层能力上限和最终成本结构的最关键一步。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['模型选型', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  {
    id: 'mvp',
    title: 'MVP（Minimum Viable Product，最小可行产品）',
    category: 'AI 行业 & 场景应用',
    summary: 'AI产品的MVP和传统产品有本质区别。',
    plain: 'AI产品的MVP和传统产品有本质区别。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['MVP（Minimum Viable Product，最小可行产品）', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  {
    id: 'pmf',
    title: 'PMF（Product Market Fit，产品市场匹配）',
    category: 'AI 行业 & 场景应用',
    summary: '判断AI产品是否达到PMF，不能只看用户的口头反馈。',
    plain: '判断AI产品是否达到PMF，不能只看用户的口头反馈。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['PMF（Product Market Fit，产品市场匹配）', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  {
    id: 'ab-testing',
    title: 'A/B Testing（A/B 测试）',
    category: 'AI 行业 & 场景应用',
    summary: 'AI产品的A/B测试比传统产品复杂得多。',
    plain: 'AI产品的A/B测试比传统产品复杂得多。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['A/B Testing（A/B 测试）', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Google ML Crash Course',
  ...
  },
  {
    ...
    title: '兜底策略',
    category: 'AI 行业 & 场景应用',
    summary: '当模型能力不足或输出异常时的最后一道防线。',
    plain: '当模型能力不足或输出异常时的最后一道防线。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['兜底策略', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  {
    id: 'maas',
    title: 'MaaS（Model as a Service，模型即服务）',
    category: 'AI 行业 & 场景应用',
    summary: '将模型能力通过API或SDK的形式提供给开发者，并按token或调用量收费的商业模式。',
    plain: '将模型能力通过API或SDK的形式提供给开发者，并按token或调用量收费的商业模式。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['MaaS（Model as a Service，模型即服务）', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  {
    id: 'paas',
    title: 'PaaS（Platform as a Service，平台即服务）',
    category: 'AI 行业 & 场景应用',
    summary: '提供AI开发、训练、部署、评估全流程的一体化工具平台，如阿里云百炼、百度智能云千帆等。',
    plain: '提供AI开发、训练、部署、评估全流程的一体化工具平台，如阿里云百炼、百度智能云千帆等。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['PaaS（Platform as a Service，平台即服务）', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  {
    id: 'saas',
    title: 'SaaS（Software as a Service，软件即服务）',
    category: 'AI 行业 & 场景应用',
    summary: '将AI能力封装成普通用户可以直接使用的。',
    plain: '将AI能力封装成普通用户可以直接使用的。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['SaaS（Software as a Service，软件即服务）', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  {
    id: 'aaas',
    title: 'AaaS（Agent as a Service，智能体即服务）',
    category: 'AI 行业 & 场景应用',
    summary: '新一代AI商业模式。',
    plain: '新一代AI商业模式。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    ...
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['AaaS（Agent as a Service，智能体即服务）', 'AI 行业 & 场景应用', 'Agent'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    category: 'AI 行业 & 场景应用',
    summary: '将完整的模型和系统部署在客户自己的本地服务器或私有云上，所有数据都不会流出客户的网络环境。',
    plain: '将完整的模型和系统部署在客户自己的本地服务器或私有云上，所有数据都不会流出客户的网络环境。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['私有化部署（Private Deployment）', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  {
    id: 'roi',
    title: 'ROI（Return on Investment，投入产出比）',
    category: 'AI 行业 & 场景应用',
    summary: '衡量一个AI项目商业价值的核心指标。',
    plain: '衡量一个AI项目商业价值的核心指标。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['ROI（Return on Investment，投入产出比）', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  {
    id: 'on-device-ai',
    title: '端侧 AI（On-device AI）',
    category: '进阶常识',
    summary: '模型直接运行在用户的手机、电脑、智能手表、汽车等本地设备上，所有计算都在本地完成。',
    plain: '模型直接运行在用户的手机、电脑、智能手表、汽车等本地设备上，所有计算都在本地完成。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['端侧 AI（On-device AI）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '能够感知物理世界并与物理世界进行交互的AI系统，例如机器人、自动驾驶汽车、工业机械臂等，是AI发展的下一个重要阶段，本质上是让AI从纯…',
    plain: '能够感知物理世界并与物理世界进行交互的AI系统，例如机器人、自动驾驶汽车、工业机械臂等，是AI发展的下一个重要阶段，本质上是让AI从纯粹的数字世界走向现实世界，从「能说会道」变成「能做事」。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['具身智能（Embodied AI）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '通过降低模型参数的数值精度，来大幅减小模型体积、加快推理速度、降低运行成本的技术。',
    plain: '通过降低模型参数的数值精度，来大幅减小模型体积、加快推理速度、降低运行成本的技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['模型量化（Quantization）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '用一个能力强大的大模型（教师模型）来指导一个小模型（学生模型）训练的技术。',
    plain: '用一个能力强大的大模型（教师模型）来指导一个小模型（学生模型）训练的技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['模型蒸馏（Distillation）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  {
    id: 'xai',
    title: 'XAI（Explainable AI，可解释性 AI）',
    category: '进阶常识',
    summary: '解决大模型「黑箱」问题的技术体系，能让模型解释自己为什么做出某个决策，提升决策过程的透明度。',
    plain: '解决大模型「黑箱」问题的技术体系，能让模型解释自己为什么做出某个决策，提升决策过程的透明度。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['XAI（Explainable AI，可解释性 AI）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '一种特殊的分布式机器学习技术。',
    plain: '一种特殊的分布式机器学习技术。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['联邦学习（Federated Learning）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  {
    id: 'privacy-computing',
    title: '隐私计算（Privacy-preserving Computing）',
    category: '进阶常识',
    summary: '一个完整的技术体系，专门用于解决AI时代的数据安全和隐私保护问题，包括联邦学习、差分隐私、同态加密、安全多方计算等多种技术，核心目标是…',
    plain: '一个完整的技术体系，专门用于解决AI时代的数据安全和隐私保护问题，包括联邦学习、差分隐私、同态加密、安全多方计算等多种技术，核心目标是实现「数据可用不可见」，在保护数据隐私的同时，充分发挥数据的价值。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['隐私计算（Privacy-preserving Computing）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  },
  {
    ...
    title: '数据飞轮',
    category: 'AI 行业 & 场景应用',
    summary: 'AI产品最核心的增长逻辑。',
    plain: 'AI产品最核心的增长逻辑。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['数据飞轮', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  },
  {
    ...
    title: '模型缓存',
    category: '进阶常识',
    summary: '降低AI产品成本最有效的手段之一，将用户常见问题的模型输出结果缓存起来，当相同或相似的问题再次出现时，直接返回缓存结果，不需要重新调用…',
    plain: '降低AI产品成本最有效的手段之一，将用户常见问题的模型输出结果缓存起来，当相同或相似的问题再次出现时，直接返回缓存结果，不需要重新调用模型。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
  ...
  },
  {
    ...
    title: '模型越狱',
    category: '进阶常识',
    summary: '用户通过精心设计的提示词，绕过模型的安全对齐机制，诱导模型输出有害、违法或不符合规范的内容。',
    plain: '用户通过精心设计的提示词，绕过模型的安全对齐机制，诱导模型输出有害、违法或不符合规范的内容。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
  ...
  },
  {
    ...
    title: 'AI 偏见（AI Bias）',
    category: '进阶常识',
    summary: '大模型会从训练数据中学习到人类社会的各种偏见（如性别偏见、种族偏见、地域偏见），并在输出中体现出来。',
    plain: '大模型会从训练数据中学习到人类社会的各种偏见（如性别偏见、种族偏见、地域偏见），并在输出中体现出来。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['AI 偏见（AI Bias）', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'NIST AI RMF',
  ...
  },
  {
    ...
    title: 'AIGC 水印',
    category: '进阶常识',
    summary: '为AI生成的内容添加不可见或可见的可追溯标识的技术，是解决深度伪造、版权侵权和内容合规问题的重要手段。',
    plain: '为AI生成的内容添加不可见或可见的可追溯标识的技术，是解决深度伪造、版权侵权和内容合规问题的重要手段。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
  ...
  {
    id: 'open-ai-ecosystem',
    title: '开源 AI 生态',
    category: 'AI 行业 & 场景应用',
    summary: '以Llama系列、HuggingFace平台为核心的开源技术体系，正在彻底改变AI行业的格局。',
    plain: '以Llama系列、HuggingFace平台为核心的开源技术体系，正在彻底改变AI行业的格局。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['开源 AI 生态', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'LM Harness',
    category: '进阶常识',
    summary: '目前行业最主流的大模型自动化评测框架，提供了一套统一的标准测试集，能够全面评估模型在知识掌握、逻辑推理、代码生成、指令遵循、数学计算等…',
    plain: '目前行业最主流的大模型自动化评测框架，提供了一套统一的标准测试集，能够全面评估模型在知识掌握、逻辑推理、代码生成、指令遵循、数学计算等多个维度的表现。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['LM Harness', '进阶常识'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '现代Agent系统的基础框架。',
    plain: '现代Agent系统的基础框架。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['ReAct（Reasoning+Acting）', '进阶常识', 'Agent'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    category: '进阶常识',
    summary: '由多个具有不同角色和能力的Agent组成，通过分工协作。',
    plain: '由多个具有不同角色和能力的Agent组成，通过分工协作。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['Multi-Agent（多智能体系统）', '进阶常识', 'Agent'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: 'Agentic RL',
    category: '进阶常识',
    summary: '专门面向Agent场景的强化学习方向。',
    plain: '专门面向Agent场景的强化学习方向。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['Agentic RL', '进阶常识', 'Agent'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'Hugging Face Docs',
  ...
  },
  {
    ...
    title: 'Skill',
    category: '进阶常识',
    summary: '面向Agent的标准化能力封装机制。',
    plain: '面向Agent的标准化能力封装机制。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['进阶理解', '项目实施', '风险边界'],
    tags: ['Skill', '进阶常识', 'Agent'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: 'Vibe Coding',
    category: 'AI 行业 & 场景应用',
    summary: '2025~2026年兴起的一种新型AI编程范式。',
    plain: '2025~2026年兴起的一种新型AI编程范式。',
    officialPoint: '该条由用户提供的 Daniel 公众号 PDF 提取，已按通识卡片改写；涉及模型、工具或行业判断时仍应回到官方文档或一手资料复核。',
    beginnerTakeaway: '先记住它解决什么问题，再看适用场景和常见误区。',
    caution: '该卡片来自 PDF 笔记的通俗化整理，暂未做逐条官方复核；面试、项目或文档交付前建议再核对。',
    useCases: ['AI 产品', '项目汇报', '业务落地'],
    tags: ['Vibe Coding', 'AI 行业 & 场景应用'],
    version: 'Daniel PDF 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'OpenAI Docs',
  ...
  },
  {
    ...
    title: '聊天框',
    category: 'AI 基础认知',
    summary: '聊天框是你向 AI 输入问题、任务和补充材料的地方。',
    plain: '它就像和 AI 沟通的窗口。你写得越清楚，AI 越容易知道要做什么、按什么格式输出、哪些地方不能乱编。',
    officialPoint: '来自 B 站视频《给AI小白的扫盲词典：60个常见术语一次搞清》的 L1 产品界面层，属于打开 AI 产品第一眼会接触到的基础入口。',
    beginnerTakeaway: '聊天框不是随便问一句的地方，而是给 AI 派任务的入口。',
    caution: '不要一次塞太多无关信息；任务、背景、限制和输出格式要分清。',
    useCases: ['日常问答', '写作改写', '资料分析'],
    tags: ['聊天框', 'AI 产品界面', '输入'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'B站：给AI小白的扫盲词典',
    sourceUrl: 'https://www.bilibili.com/video/BV1F4GX6UEqx/',
    image: '/images/cards/responses-api.webp'
  },
  {
    id: 'input-output',
    title: '输入 / 输出',
    category: 'AI 基础认知',
    summary: '输入是你给 AI 的内容，输出是 AI 返回的结果。',
    plain: '输入可以是问题、文档、图片或指令；输出可以是回答、表格、代码、图片描述或下一步操作建议。',
    officialPoint: '来自视频的 L1 产品界面层，是理解所有 AI 工具的最基础概念。',
    beginnerTakeaway: '先想清楚你给 AI 什么，再判断它返回的结果能不能直接用。',
    caution: '输出不等于事实，重要内容要核对来源或人工复核。',
    useCases: ['提示词', '结构化输出', '工作流'],
    tags: ['输入', '输出', 'I/O'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '联网搜索',
    category: 'AI 基础认知',
    summary: '联网搜索让 AI 临时查网页，再基于搜索结果回答。',
    plain: '它适合查最新信息、产品价格、新闻、政策和资料来源。和普通聊天不同，联网搜索应该能给你可核对的链接。',
    officialPoint: '来自视频的 L1 产品界面层，是小白判断 AI 是否能查新资料的重要入口。',
    beginnerTakeaway: '需要最新资料时，优先用带来源链接的联网搜索。',
    caution: 'AI 可能误读网页或引用旧内容，关键结论仍要点开原文看日期和上下文。',
    useCases: ['资料调研', '竞品查询', '来源核验'],
    tags: ['联网搜索', 'AI 搜索', '来源'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '对话历史',
    category: 'AI 基础认知',
    summary: '对话历史是你和 AI 之前交流内容的记录。',
    plain: '它能帮助你找回以前的问题、答案和思路；有些产品还会基于历史内容继续上下文或形成偏好。',
    officialPoint: '来自视频的 L1 产品界面层，是持续学习和复盘的重要入口。',
    beginnerTakeaway: '对话历史适合复盘学习，但不等于长期可靠知识库。',
    caution: '涉及隐私、账号、客户资料和公司文件时，不要随意保存在对话里。',
    useCases: ['学习复盘', '任务延续', '资料找回'],
    tags: ['对话历史', '上下文', '记忆'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '模型',
    category: 'AI 基础认知',
    summary: '模型是 AI 背后真正处理输入并生成输出的能力核心。',
    plain: '同一个聊天产品里可能有不同模型。模型不同，推理、写作、图片、速度、价格和上下文能力都会不一样。',
    officialPoint: '来自视频的 L2 使用基础层，是理解“为什么同一问题不同 AI 回答不同”的关键。',
    beginnerTakeaway: '产品是入口，模型是发动机。',
    caution: '不要只看模型名字，实际还要看任务效果、成本、速度和可用工具。',
    useCases: ['模型选型', '工具对比', 'AI 产品理解'],
    tags: ['模型', '大模型', '选型'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '知识库',
    category: 'AI 基础认知',
    summary: '知识库是给 AI 查询的资料集合，用来补充模型不知道或容易过时的信息。',
    plain: '你可以把公司文档、产品手册、课程笔记放进去，让 AI 先找资料再回答，这就是很多 RAG 应用的基础。',
    officialPoint: '来自视频的 L2 使用基础层，强调它是提升问答准确性的重要概念。',
    beginnerTakeaway: '知识库解决“让 AI 看指定资料再回答”的问题。',
    caution: '知识库效果取决于资料质量、切分方式、检索准确率和来源更新。',
    useCases: ['企业问答', '学习笔记', '客服知识库'],
    tags: ['知识库', 'RAG', '资料'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '插件',
    category: 'AI 配套技术',
    summary: '插件让 AI 接入外部工具或服务，获得聊天之外的能力。',
    plain: '例如查日历、读文档、搜索网页、操作表格、调用业务系统。插件让 AI 不只是回答，还能连接工具。',
    officialPoint: '来自视频的 L2 使用基础层，是理解 AI 工具扩展能力的入口。',
    beginnerTakeaway: '插件是给 AI 加能力的外接工具。',
    caution: '插件可能读取或修改真实数据，必须注意权限、账号和操作确认。',
    useCases: ['工具调用', '办公自动化', 'AI 助手'],
    tags: ['插件', '工具调用', '权限'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: 'System Prompt',
    category: '进阶常识',
    summary: 'System Prompt 是给模型设定身份、规则和边界的高优先级指令。',
    plain: '它通常不直接给用户改，而是由产品或开发者设定，用来规定 AI 应该扮演什么角色、遵守什么规则、不能做什么。',
    officialPoint: '来自视频的 L3 模型理解层，用来解释 AI 行为边界从哪里来。',
    beginnerTakeaway: '普通提示词像临时要求，System Prompt 更像系统规则。',
    caution: '不要把 System Prompt 当万能安全锁，仍要配合权限、审核和测试。',
    useCases: ['AI 应用设计', '角色设定', '安全边界'],
    tags: ['System Prompt', '提示词', '规则'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
    sourceName: 'B站：给AI小白的扫盲词典',
  ...
  },
  {
    ...
    title: '工作流',
    category: 'AI 配套技术',
    summary: '工作流是把多个步骤按顺序或条件串起来自动执行。',
    plain: '例如收到表单后提取需求、查资料、生成总结、写入表格、发送通知。AI 只是其中一个节点。',
    officialPoint: '来自视频的 L4 AI 概念与自动化层，是从聊天走向办事的关键概念。',
    beginnerTakeaway: '工作流解决“重复步骤自动跑”的问题。',
    caution: '工作流会真实执行动作，必须设计失败处理、人工确认和日志。',
    useCases: ['n8n', 'Dify', '自动日报'],
    tags: ['工作流', '自动化', '节点'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: 'API',
    category: 'AI 配套技术',
    summary: 'API 是程序之间互相调用能力和交换数据的接口。',
    plain: '你可以把 API 理解成软件之间的“点单窗口”：一个系统按规定格式发请求，另一个系统返回结果。',
    officialPoint: '来自视频的 L4 AI 概念与自动化层，是 AI 应用连接外部系统的基础。',
    beginnerTakeaway: '想让 AI 接业务系统，迟早要理解 API。',
    caution: 'API 调用要保护密钥、权限和请求日志，不要把 key 写进公开代码。',
    useCases: ['模型调用', '系统集成', 'Webhook'],
    tags: ['API', 'HTTP', 'JSON'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '前端',
    category: '前端 & 网页搭建',
    summary: '前端是用户在浏览器或 App 里直接看到和操作的界面部分。',
    plain: '按钮、卡片、搜索框、页面布局、动画和交互反馈都属于前端范围。你的知识卡片网站主要就是前端页面。',
    officialPoint: '来自视频的开发与部署层，是动手做网页和 AI 产品原型必须知道的概念。',
    beginnerTakeaway: '前端负责“看得见、点得到、用得顺”。',
    caution: '前端不能直接暴露密钥和敏感业务逻辑。',
    useCases: ['网页搭建', '产品原型', '交互设计'],
    tags: ['前端', 'HTML', 'CSS'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '后端',
    category: '前端 & 网页搭建',
    summary: '后端是运行在服务器上，负责数据、权限、业务逻辑和接口的部分。',
    plain: '前端负责展示，后端负责处理请求、读写数据库、调用模型 API、校验权限并返回结果。',
    officialPoint: '来自视频的开发与部署层，用来区分网页界面和服务器逻辑。',
    beginnerTakeaway: '后端负责“看不见但真正处理事情”。',
    caution: '涉及账号、密钥、数据库和模型调用时，一般不应只放在前端。',
    useCases: ['API 服务', '数据库', '模型调用'],
    tags: ['后端', '服务器', 'API'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '服务器',
    category: 'AI 配套技术',
    summary: '服务器是用来运行网站、接口、数据库或 AI 应用的计算机环境。',
    plain: '本地电脑也能临时当服务器，但正式给别人访问，通常需要云服务器、托管平台或内网部署环境。',
    officialPoint: '来自视频的开发与部署层，是理解网站上线和 AI 应用运行位置的基础。',
    beginnerTakeaway: '服务器就是让程序持续运行并对外提供服务的地方。',
    caution: '服务器要管理端口、域名、权限、日志、备份和安全更新。',
    useCases: ['网站部署', 'API 服务', '私有化部署'],
    tags: ['服务器', '部署', '端口'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: '神经网络',
    category: 'AI 基础认知',
    summary: '神经网络是一类通过多层计算从数据中学习规律的模型结构。',
    plain: '它并不是真的人脑，而是由很多可调整的参数组成，通过训练不断调整，让输入和正确答案越来越接近。',
    officialPoint: '来自视频的 L7 模型原理与硬件层，用来理解大模型的基础结构。',
    beginnerTakeaway: '神经网络是很多现代 AI 模型的基础积木。',
    caution: '小白阶段不必先学复杂公式，先理解它靠数据训练参数。',
    useCases: ['机器学习入门', '深度学习', '模型原理'],
    tags: ['神经网络', '深度学习', '参数'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  {
    id: 'model-parameters-basic',
    title: '参数',
    category: 'AI 基础认知',
    summary: '参数是模型训练后保存下来的内部数值，决定模型如何处理输入。',
    plain: '可以粗略理解成模型学到的“经验刻度”。参数越多不一定越好，但通常意味着模型容量更大、成本也更高。',
    officialPoint: '来自视频的 L7 模型原理与硬件层，是理解模型规模的基础概念。',
    beginnerTakeaway: '参数是模型学到的内部权重，不是知识点数量。',
    caution: '不要只用参数量判断模型强弱，数据、训练方法、架构和产品优化同样重要。',
    useCases: ['模型规模', '选型对比', '成本理解'],
    tags: ['参数', '模型规模', '训练'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  {
    id: 'ai-three-elements',
    title: '算法 / 数据 / 算力',
    category: 'AI 基础认知',
    summary: '算法、数据和算力是推动 AI 能力提升的三类核心要素。',
    plain: '算法决定怎么学，数据决定学什么，算力决定能训练和运行多大的模型。三者缺一块，AI 效果都会受限制。',
    officialPoint: '来自视频的 L7 模型原理与硬件层，用来解释 AI 能力上限从哪里来。',
    beginnerTakeaway: 'AI 不是只靠模型名字强，背后还要看数据和算力。',
    caution: '算力多不自动等于效果好，低质量数据会放大偏差和错误。',
    useCases: ['AI 原理', '行业理解', '模型训练'],
    tags: ['算法', '数据', '算力'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  },
  {
    ...
    title: 'GPU',
    category: 'AI 配套技术',
    summary: 'GPU 是擅长并行计算的芯片，常用于训练和运行 AI 模型。',
    plain: '大模型需要大量矩阵计算，GPU 可以同时处理很多计算任务，所以比普通 CPU 更适合 AI 训练和推理。',
    officialPoint: '来自视频的 L7 模型原理与硬件层，是理解 AI 算力成本的基础。',
    beginnerTakeaway: 'GPU 是 AI 算力的重要来源。',
    caution: 'GPU 贵且耗电，实际项目要看是否必须本地跑模型。',
    useCases: ['模型训练', '本地部署', '推理加速'],
    tags: ['GPU', '算力', '硬件'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
  ...
  {
    id: 'data-center-basic',
    title: '数据中心',
    category: 'AI 配套技术',
    summary: '数据中心是集中放置大量服务器、网络和存储设备的基础设施。',
    plain: '大型 AI 模型训练和服务通常不在一台电脑上完成，而是在数据中心里用大量 GPU、服务器和网络协同运行。',
    officialPoint: '来自视频的 L7 模型原理与硬件层，用来理解 AI 服务背后的基础设施。',
    beginnerTakeaway: '你在网页上问 AI，背后可能是数据中心在提供算力。',
    caution: '数据中心涉及成本、能耗、散热、网络稳定性和安全合规。',
    useCases: ['云服务', 'AI 基础设施', '模型服务'],
    tags: ['数据中心', '服务器', '算力'],
    version: 'B站视频 BV1F4GX6UEqx 2026-07',
    updated: '2026-07',
    sourceLevel: '待人工复核',
